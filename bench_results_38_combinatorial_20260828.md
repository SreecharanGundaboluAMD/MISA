...
| fwd | 512,1,1,32,1x1 | combo_64x64 | 0.01600 | 0.00800 | 0.00971 | 2.00x slower | 1.65x slower | 137/ConvHipImplicitGemmGroupFwdXdlops |
| fwd | 32,1,1,512,1x1 | combo_128x64 | 0.00900 | 0.00629 | 0.00847 | 1.43x slower | 1.06x slower | 137/ConvHipImplicitGemmGroupFwdXdlops |
...
| fwd | 128,30,40,512,1x1 | mtail | 0.02900 | 0.02189 | 0.02047 | 1.32x slower | 1.42x slower | 220/ConvHipConv |
| fwd | 256,30,40,128,1x1 | mtail | 0.01700 | 0.01366 | 0.01492 | 1.24x slower | 1.14x slower | 220/ConvHipConv |
| fwd | 192,60,80,64,1x1 | combo_128x64 | 0.02200 | 0.02282 | 0.03615 | 1.04x faster | 1.64x faster | 137/ConvHipImplicitGemmGroupFwdXdlops |
...
| fwd | 24,240,320,128,1x1 | combo_128x128 | 0.18000 | 0.17973 | 0.16886 | 1.00x slower | 1.07x slower | 137/ConvHipImplicitGemmGroupFwdXdlops |
...
| fwd | 192,120,160,48,1x1 | combo_64x64 | 0.06500 | 0.08065 | 0.07747 | 1.24x faster | 1.19x faster | 137/ConvHipImplicitGemmGroupFwdXdlops |
...
| bwd | 128,30,40,128,3x3 | combo_32x32 | 0.07400 | 0.05621 | 0.02388 | 1.32x slower | 3.10x slower | 220/ConvHipConv |
| bwd | 64,60,80,256,1x1 | combo_32x32 | 0.04100 | 0.03461 | 0.04199 | 1.18x slower | 1.02x faster | 220/ConvHipConv |
| bwd | 512,30,40,128,1x1 | combo_64x64 | 0.04000 | 0.03528 | 0.02179 | 1.13x slower | 1.84x slower | 220/ConvHipConv |
| bwd | 128,120,160,128,3x3 | base | 0.59800 | 0.50721 | 0.31830 | 1.18x slower | 1.88x slower | 220/ConvHipConv |
...
| bwd | 192,60,80,64,1x1 | combo_64x64 | 0.03800 | 0.03852 | 0.03283 | 1.01x faster | 1.16x slower | 220/ConvHipConv |
| bwd | 128,30,40,128,1x1 | combo_64x64 | 0.01500 | 0.01779 | 0.01274 | 1.19x faster | 1.18x slower | 220/ConvHipConv |
| bwd | 256,60,80,64,1x1 | base | 0.04200 | 0.04617 | 0.03716 | 1.10x faster | 1.13x slower | 220/ConvHipConv |
| wrw | 128,30,40,128,3x3 | combo_64x64 | 0.41900 | 0.08654 | 0.06740 | 4.84x slower | 6.22x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 128,120,160,128,3x3 | combo_64x64 | 2.22900 | 0.66439 | 0.41365 | 3.35x slower | 5.39x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 192,60,80,64,1x1 | combo_64x64 | 0.06500 | 0.05720 | 0.00561 | 1.14x slower | 11.59x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 256,30,40,128,1x1 | combo_64x64 | 0.08500 | 0.03579 | 0.02838 | 2.37x slower | 3.00x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 512,30,40,128,1x1 | combo_64x64 | 0.09500 | 0.04728 | 0.04997 | 2.01x slower | 1.90x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
...
| wrw | 64,60,80,128,1x1 | combo_64x64 | 0.06200 | 0.05149 | 0.04026 | 1.20x slower | 1.54x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 64,60,80,256,1x1 | gsplit | 0.06700 | 0.05810 | 0.05214 | 1.15x slower | 1.29x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |
| wrw | 256,60,80,64,1x1 | combo_64x64 | 0.06400 | 0.05890 | 0.05217 | 1.09x slower | 1.23x slower | 156/ConvHipImplicitGemmGroupWrwXdlops |

Summary (avg ratio, MISA/MIOpen -- >1 means MISA is slower):
- fwd: vs gfx950 avg 1.22x, vs gfx1250 avg 1.07x (17 shapes)
- bwd: vs gfx950 avg 1.04x, vs gfx1250 avg 1.50x (11 shapes)
- wrw: vs gfx950 avg 2.03x, vs gfx1250 avg 3.56x (10 shapes)
