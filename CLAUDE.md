...
| `config/igemm_fwd_gtc_gfx1250_nhwc_fp16_all.config` | Master gfx1250 WMMA flat config (union of all validated fp16 fwd tunable combinations; use this for benchmarking and quick-start) |
